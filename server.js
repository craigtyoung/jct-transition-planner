...
JCT is weighing MULTIPLE paths, not just building: (1) Academy-only — bring JCT's elite academy into another club (this is the LEAD direction; the academy is ~72% of revenue and is JCT's real asset, alongside 500 members + a 200-person waitlist); (2) Partnership / revenue-share with a host club; (3) Buyout / acquire an existing facility; (4) Build a new facility (the earlier "Jim Capstick / William Halton Parkway" plan — note that specific site FELL THROUGH; the build research and cost model below are retained as reference for any future build); (5) Land / site — vacant parcels being evaluated as a future from-scratch build location, tracked separately from club/partner conversations. The Opportunities data tracks target clubs, partners, and land parcels as deal conversations.
